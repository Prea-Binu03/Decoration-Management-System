...
{ 
  ...
  <body>
      ...
      <nav class="navbar navbar-inverse" role="navigation">
        ...
        <div id="main-nav" class="collapse navbar-collapse adeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
          <ul class="nav navbar-nav" id="mainNav">
            ...
            <li><a href="index.php" class="scroll-link">Service</a></li>
   ...
   <div id="top"></div>
<section id="home">
  <div class="banner-container" style="height: 300px; background: url('images/bg.jpg') no-repeat center center; background-size: cover;">
    <div class="container banner-content">
      <div id="da-slider" class="da-slider">
        <div>&nbsp;</div>
        <div class="">
          <h2>Decoration Management System</h2>
          <p>Decoration management system gives you great decor packages.. enjoy!!!</p>
