      ...
      <div class="top-header">
        <div class="container">
          <ul class="tp-hd-lft wow fadeInLeft animated" data-wow-delay=".5s">
            ...
            <li class="prnt"><a href="tour_history.php">My History</a></li>
          </ul>
   ...
   <div class="container banner-content">
    <div id="da-slider" class="da-slider">
     ...
     <div class="">
      ...
      <p>A well-organized decoration system turns dreams into reality, making every event special".. enjoy!!!</p>
